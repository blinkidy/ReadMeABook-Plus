...
Audiobook details can also include optional Hardcover enrichment: ebook page count, ISBN, and a Hardcover source link. This enrichment is best-effort and does not block Audible details.
